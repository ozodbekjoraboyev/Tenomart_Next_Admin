...
const AnimatedButton = ({ text }: { text: string }) => {
  return (
    <button className="relative px-6 py-2 font-bold uppercase tracking-wide transition-all duration-500 border-none cursor-pointer hover:text-green-400 text-black hover:drop-shadow-glow">
